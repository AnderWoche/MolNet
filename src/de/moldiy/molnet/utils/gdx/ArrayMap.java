...
package de.moldiy.molnet.utils.gdx;

import java.util.Arrays;
import java.util.Iterator;
import java.util.NoSuchElementException;

import de.moldiy.molnet.utils.gdx.math.MathUtils;
import de.moldiy.molnet.utils.gdx.ObjectMap.Entry;
import de.moldiy.molnet.utils.gdx.reflect.ArrayReflection;
...
public class ArrayMap<K, V> implements Iterable<ObjectMap.Entry<K, V>> {
	...
	public @Null
	V get (K key, @Null V defaultValue) {
